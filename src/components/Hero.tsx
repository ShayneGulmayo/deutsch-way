...
import bannerImage from '../assets/deutsch-way_banner.png'
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-24 pb-16 sm:pt-32 sm:pb-24">
      ...
      />
      <div
        className="absolute inset-0 -z-10 bg-cover bg-right bg-no-repeat opacity-40 sm:opacity-50 dark:opacity-35 dark:sm:opacity-45"
        style={{ backgroundImage: `url(${bannerImage})` }}
        aria-hidden="true"
      />
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-[var(--bg-primary)] from-40% via-[var(--bg-primary)]/70 to-transparent" />
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-10 lg:gap-12">
          <div>
            <div className="animate-fade-up mb-6 inline-flex items-center gap-2 rounded-full border border-german-gold/40 bg-german-gold/10 px-4 py-1.5 backdrop-blur-sm">
            ...
            <div className="animate-fade-up-delay-2 mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <a
                href="#assessment"
                className="inline-flex items-center justify-center rounded-full border-2 border-german-gold bg-german-gold/10 px-8 py-3.5 text-base font-semibold text-[var(--text-primary)] backdrop-blur-sm transition-all hover:bg-german-gold/20"
              >
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div
              key={item.label}
              className="rounded-2xl border border-[var(--border-color)] bg-[var(--bg-elevated)]/90 p-6 text-center shadow-[var(--card-shadow)] backdrop-blur-sm"
            >
